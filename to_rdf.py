...
def to_rdf(argv):
    ...
    dst_file = '//shiner.win.ad.jhu.edu/repec/jhu/papers/result.rdf' # Connect to VPN. map drive "\\shine.win.ad.jhu.edu\repec\papers\test" on Windows invert backlash for Mac. 
    ...
    # dst_file = '/Users/marce/Dropbox/Documents/CodeProjects/gittry/result.rdf'
    jhu_people = get_jhu()
    dst_ids = []
